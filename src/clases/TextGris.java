 ...
 * class construction.
 */
public class TextGris extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public TextGris(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public TextGris(String text, JTextComponent component, Show show) {
